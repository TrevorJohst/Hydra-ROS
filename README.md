...
Hydra has been tested on Ubuntu 22.04 and ROS2 Iron. See [here](doc/ros2_setup.md) to get started with Hydra and ROS2. See [here](docker/README.md) for using Hydra with docker.
